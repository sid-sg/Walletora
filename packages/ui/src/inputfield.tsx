...
const InputField = ({ type, label, placeholder, value, onChange, error }: inputType) => {
  ...
  return <div className='mb-2'>
    ...
    <div className='relative'>
      <input type={visible ? 'text' : type} placeholder={placeholder} value={value} onChange={onChange} className={`mt-1 w-full p-2.5 bg-gray-800 border ${error ? 'border-red-500' : 'border-gray-700'
